...
<head>
	<title>Promociones | {{ $landing->nombre }}</title>

	<!-- Meta -->
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=Edge">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="Promociones Valdex Mobile">

	<!-- Favicon -->
	<link rel="shortcut icon" href="{{ asset('/favicon.ico') }}">

	<!-- LOADING FONTS AND ICONS -->
	<link href="http://fonts.googleapis.com/css?family=Raleway:400,500,600,100" rel="stylesheet" property="stylesheet" type="text/css" media="all">

	<link rel="stylesheet" type="text/css" href="{{ asset('landing/plugins/revolution-slider/revolution/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('landing/plugins/revolution-slider/revolution/fonts/font-awesome/css/font-awesome.min.css') }}">

	<!-- REVOLUTION STYLE SHEETS -->
	<link rel="stylesheet" type="text/css" href="{{ asset('landing/plugins/revolution-slider/revolution/css/settings.css') }}">
	<!-- REVOLUTION LAYERS STYLES -->
	<link rel="stylesheet" type="text/css" href="{{ asset('landing/plugins/revolution-slider/revolution/css/layers.css') }}">
...
<section class="example">
	<article class="content">
		...
		style="z-index: 14; white-space: nowrap; font-size: 16px; line-height: 48px; font-weight: 600; color: rgba(255, 255, 255, 1.00);font-family:Raleway;background-color:rgba(51, 51, 51, 1.00);padding:0px 40px 0px 40px;border-color:rgba(0, 0, 0, 1.00);border-width:2px;letter-spacing:1px;">Cual es la Promoción
		</div>
		</li>
		<!-- SLIDE -->
...
para trabajar comodamente en casa o en tu oficina.<br>
		...
		style="z-index: 10; white-space: nowrap;letter-spacing:1px;">Como la compro
		</div>
		</li>
		<!-- SLIDE -->
		...
		data-videomp4="{{ asset('landing/plugins/revolution-slider/assets/videos/officeloop_low.mp4')}}"
		...
		style="z-index: 6; white-space: nowrap;text-align:center;"><span class="text-center">CORRE A LA SUCURSAL<br>
		VALDEZ MOBILE<br>
		MAS CERCANA </span>
		</div>
		...
		style="z-index: 8; min-width: 448px; max-width: 448px; white-space: normal;text-align:center;">Sucursal Merliot<br>
Sucursal Escalón<br>
Sucursal San Miguel<br>
		</div>

		<!-- LAYER NR. 5 -->
		<a class="tp-caption WebProduct-Button rev-btn "
		href="https://www.waze.com/es-419/livemap?zoom=15&lat=13.67657&lon=-89.26274&from_lat=13.67657&from_lon=-89.26274&to_lat=13.67657&to_lon=-89.26274&at_req=0&at_text=Now" target="_blank" id="slide-254-layer-8"
		data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
		data-y="['middle','middle','top','top']" data-voffset="['268','268','456','430']"
		data-width="none"
		data-height="none"
		...
		style="z-index: 9; white-space: nowrap;letter-spacing:1px;">MAPA
		</a>
		</li>
		</ul>
		...
		style="z-index: 5; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 400; color: rgba(255, 255, 255, 1.00);"><div id="rev-burger">
		<span></span>
		<span></span>
		<span></span>
		</div>
		...
		style="z-index: 8; white-space: nowrap;">INICIO
		</div>
		...
		data-end="bytrigger"
		data-lasttriggerstate="keep"
		style="z-index: 9; white-space: nowrap;">PROMOCIÓN
		</div>
		...
		data-end="bytrigger"
		data-lasttriggerstate="keep"
		style="z-index: 10; white-space: nowrap;">COMO
		</div>
		...
		data-end="bytrigger"
		data-lasttriggerstate="keep"
		style="z-index: 11; white-space: nowrap;"><a href="https://www.waze.com/es-419/livemap?zoom=15&lat=13.67657&lon=-89.26274&from_lat=13.67657&from_lon=-89.26274&to_lat=13.67657&to_lon=-89.26274&at_req=0&at_text=Now" target="_blank" title="WAZE"><i class="fa fa-map-marker fa-fw"></i></a> &nbsp; <a href="tel://+50322013008" title="llama ya!"><i class="fa fa-tty fa-fw"></i></a>
		</div>
		</div>
...
<!-- REVOLUTION JS FILES -->
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/jquery.themepunch.tools.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/jquery.themepunch.revolution.min.js') }}"></script>

<!-- SLIDER REVOLUTION 5.0 EXTENSIONS (Load Extensions only on Local File Systems ! The following part can be removed on Server for On Demand Loading) -->
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.actions.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.carousel.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.kenburn.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.migration.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.navigation.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.parallax.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.slideanims.min.js') }}"></script>
<script src="{{ asset('landing/plugins/revolution-slider/revolution/js/extensions/revolution.extension.video.min.js') }}"></script>
	...
	tpj(document).ready(function() {
		if(tpj("#rev_slider_72_1").revolution == undefined){
			...
			revapi72 = tpj("#rev_slider_72_1").show().revolution({
				sliderType:"standard",
				jsFileLocation:"assets/plugins/revolution-slider/revolution/js/",
